      ...
      <div className="flex flex-col md:flex-row items-center justify-between mb-16 gap-6">
        <div className="text-center md:text-left">
          <motion.h1 
            ...
            className="text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-linear-to-r from-primary to-purple-400 mb-4"
          >
        ...
        {ALL_TEMPLATES.map((item, index) => (
          ...
          >
            ...
            >
              ...
              <div className={`h-48 bg-linear-to-br ${item.gradient} p-6 flex items-center justify-center relative overflow-hidden`}>
